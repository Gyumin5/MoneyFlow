...
- D_SMA42 단일 (ENSEMBLE_WEIGHTS = {'D_SMA42': 1.0})
- snap_interval_bars=57, n_snapshots=3 (57 = 3 × 19, prime stagger=19)
- canary_hyst=0.015, universe_size=3, cap=1/3
- drift_threshold=0.05 (자본금 기준; cur_w fut = positions['real_weight'])
- 단독 sleeve (BT 5.4yr, L3): CAGR +450%, MDD -42%, Cal 10.74
