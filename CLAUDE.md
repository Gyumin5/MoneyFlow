...
### 자산배분 (V23 갱신 2026-05-04)

- 주식 70% / 업비트 15% / 바이낸스 15% (이전 60/40/0 → 신규 70/15/15)
- AI 균형 권고. BL 대비 Cal 3.37 → 4.96 (+47%), CAGR +40% → +69%, MDD -12% → -13.9% (+1.9pp 위험)
- 리밸 트리거: half_turnover (sum|cur-tgt|/2) ≥ 15pp. 초과 시 텔레그램 알림 — 2D sweep robust 1위 (2026-05-05 갱신, 이전 sleeve r30)
