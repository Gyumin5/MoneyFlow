...
### 자산배분 (V23 갱신 2026-05-26, B 안 채택 — per-sleeve buffer + 수동 송금)

- 주식 계좌 65% / 업비트 20% / 바이낸스 15% (stock 계좌 안에 cash buffer 포함)
  - 이전: 60/25/15 (M 안, 2026-05-22) → 신규 65/20/15 (B 안, 2026-05-26)
  - stock 실투자 = 65 × 0.93 = 60.45% of total (≈ 기존 60%)
  - total cash ≈ 4.9% (65×0.07 + 20×0.01 + 15×0.01)
  - 변경 근거: alloc_buf5 + per_sleeve_buffer BT — 65/20/15 + stock 7% + 코인 1% 가 BT 60/20/15/5 와 동일 (Cal 3.88, MDD -18.4%, CAGR 71.2%; 60/25/15 baseline 2.58 대비 +1.30 Cal)
- Per-sleeve cash buffer (V23 B 안):
  - stock 계좌 (KIS): 7% cash (계좌 내부 cash buffer, 송금 즉시 활용)
  - spot 계좌 (Upbit): 1% KRW
  - fut 계좌 (Binance): 1% USDT
  - 총 cash ≈ 5% of total
- 리밸 트리거 (OR 조합):
  - T1: half_turnover (sum|cur_w - tgt_w|/2) ≥ 13pp
...
- 자산배분 자동 rebal 폐지 (B 안 핵심):
  ...
  - 각 sleeve executor 는 자기 계좌 내부에서만 자동매매 (sleeve 내부 신호 — V23 stock SP / spot D_SMA42 / fut D_SMA42)
...
- BT 결과 (5.13yr, V23 sleeve, 알림 시점 100% 송금 가정):
