#!/usr/bin/env python3
"""V24 실거래 선물 전략 설정 (1D 단일 멤버, 2026-05-04 갱신).

V24 갱신 (2026-05-04, n=5 sn=95 d=0.03):
...
CURRENT_STRATEGIES = {
    "D_SMA42": dict(
        ...
        mom_long_bars=127,
        canary_hyst=0.015,
        drift_threshold=0.03,        # V24 갱신 (05-04): 0.05 → 0.03
        dd_threshold=0,
        dd_lookback=0,
        bl_drop=0,
        bl_days=0,
        ...
        snap_interval_bars=95,       # V24 갱신 (05-04): 57 → 95 (5*19)
    ),
}
