...
> ⚠️ 이 가이드(기준일 2026-04-02)는 V19/d005 4h 3전략 탐색용이다. 현행 선물 V25 백테스트는
> `backtest_futures_v25.py` (CROSS 청산 + 동적 L) 를 쓴다. 아래 4h 조합 탐색은 V25 에선 불필요
> (1D 단일 sleeve + AI 동적 L). 현행 스펙은 [`../../V25_OPERATION_MANUAL.md`](../../V25_OPERATION_MANUAL.md).

기준일: 2026-04-02

이 문서는 바이낸스 선물 전략 백테스트를 어떻게 재현하는지 정리한 실행 가이드다 (V19/d005 시절 기준).
